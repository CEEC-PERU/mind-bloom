...
const HomeScreen: React.FC<{ navigation: NavigationProp<any> }> = ({
  ...
  const filterCourses = (text: string) => {
    return courseData.campaignCourses.filter((course) =>
      course.Course.name.toLowerCase().includes(text.toLowerCase())
    );
  };
    ...
    >
      <View style={[styles.container]}>
        ...
        <View style={{ margin: 20 }}>
          <Text
            style={[textStyles.headerText, { color: '#3C63FF', fontSize: 40 }]}
          >
            ¡Hola {firstName}!
          </Text>
        ...
        <Text
          style={[
            ...
            textStyles.courseTitle,
            { color: '#3C63FF', marginLeft: 20 },
          ]}
        >
          Cursos
        </Text>
        ...
        <ScrollView
          contentContainerStyle={[styles.scrollViewContent, { zIndex: 100 }]}
        >
              ...
              >
                <Card
                  ...
                  containerStyle={[
                    ...
                    { backgroundColor: course.Course.background_color },
                  ]}
                >
                  <View style={styles.cardContent}>
                    ...
                    <View style={styles.contentContainer}>
                      <Text style={textStyles.courseTitle}>
                        {course.Course.name}
                      </Text>
                      {course.Course.logo ? (
                        <View style={styles.logoContainer}>
                          <Image
                            source={{ uri: course.Course.logo }}
                            style={styles.logo}
                          />
                        </View>
                      ) : null}
