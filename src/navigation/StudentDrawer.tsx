  ...
  return (
    <Drawer.Navigator
      ...
      screenOptions={{
        ...
        headerRight: () => (
          <Logo width={110} style={{ marginHorizontal: 35 }} />
        ),
...
const StudentNav = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    />
    <Stack.Screen
      name="ResultDiccionario"
      component={ResultDiccionario}
      options={{
        headerTintColor: 'white',
        headerRight: () => (
          <Logo width={110} style={{ marginHorizontal: 35 }} />
